...
|----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|---------------------------------------------------------------------|----------|--------|
| `backend/src/main/java/com/aleksandrm/mynotions/service/WorkspaceService.java`         | Service directly reads `SecurityContextHolder` and casts principal                     | Application logic coupled to framework context; harder unit testing | High     | Resolved (2026-03-12) |
| `backend/src/main/java/com/aleksandrm/mynotions/service/PageService.java`              | Same direct security-context dependency pattern                                        | Repeated coupling and duplicated auth extraction logic              | High     | Resolved (2026-03-12) |
...
- Same boundary extraction was also applied to `EventsService` for consistency.
